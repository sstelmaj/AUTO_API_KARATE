...
qa-agent          → /unit-testing           → pom.xml, karate-config.js, TestRunner.java, *.feature
...
| unit-testing | `/unit-testing` | Genera proyecto Karate completo (pom.xml, config, runner, .feature files) |

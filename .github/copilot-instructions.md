...
2. **QA + Implementación**: `qa-agent` genera Gherkin, riesgos e implementa `.feature` files Karate DSL con pom.xml, karate-config.js y TestRunner.java.
...
- `/unit-testing` — genera proyecto Karate completo: pom.xml, karate-config.js, TestRunner.java y .feature files
